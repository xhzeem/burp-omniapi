...
import dev.omnibridge.model.CookieDto
import dev.omnibridge.model.CookieSetRequest
import dev.omnibridge.model.HttpSendRequest
...
class HttpHandler(private val api: MontoyaApi, private val gate: OperationGate) {
    ...
    @OpenApi(
        ...
        responses = [OpenApiResponse(status = "200", content = [OpenApiContent(from = dev.omnibridge.model.HttpMessageDto::class)])],
