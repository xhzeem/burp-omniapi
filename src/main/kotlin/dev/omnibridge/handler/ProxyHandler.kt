...
import dev.omnibridge.model.InterceptCommand
import dev.omnibridge.model.InterceptStatus
import dev.omnibridge.model.HttpMessagePage
...
class ProxyHandler(
    ...
    @OpenApi(
        ...
        responses = [
            ...
            OpenApiResponse(status = "401", content = [OpenApiContent(from = dev.omnibridge.model.ErrorResponse::class)]),
            OpenApiResponse(status = "403", content = [OpenApiContent(from = dev.omnibridge.model.ErrorResponse::class)])
        ],
