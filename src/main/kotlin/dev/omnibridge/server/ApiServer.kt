...
import dev.omnibridge.handler.BambdaHandler
import dev.omnibridge.handler.CollaboratorHandler
import dev.omnibridge.handler.ConfigurationHandler
import dev.omnibridge.handler.HttpHandler
import dev.omnibridge.handler.IntruderHandler
import dev.omnibridge.handler.ProxyHandler
import dev.omnibridge.handler.RepeaterHandler
import dev.omnibridge.handler.ScannerHandler
import dev.omnibridge.handler.SystemHandler
import dev.omnibridge.handler.TargetHandler
import dev.omnibridge.handler.ToolsHandler
import dev.omnibridge.handler.UtilitiesHandler
import dev.omnibridge.handler.WebSocketHandler
import dev.omnibridge.mcp.McpHandler
import dev.omnibridge.model.ErrorResponse
...
class ApiServer(
    ...
    companion object {
        private const val REQUEST_ID = "omnibridge.requestId"
